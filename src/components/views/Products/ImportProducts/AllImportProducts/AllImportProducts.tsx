...
import importProductsData from "@/data/products/importProduct.json";

export default function AllImportProducts() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--color-neutral-gray)] max-w-3xl mx-auto">
            Trusted import solutions to meet your business needs with efficient
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {importProductsData.importProducts.map((product) => (
            <div
              key={product.id}
              ...
              <Link href={`/products/${product.slug}`} className="block">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="inline-block px-3 py-1 rounded-full text-xs font-bold bg-blue-500/90 text-white backdrop-blur-sm">
                      IMPORT
                    </span>
                  </div>
